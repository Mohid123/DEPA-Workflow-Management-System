    ...
    template: `
      <ng-container>
        <div class="flex justify-start gap-x-2 mt-2">
          <a (click)="showAddOrEditDialog(editTemplate, cellValue?.data)"  class="w-7 px-1 pt-1 pb-1.5 text-xs font-medium text-center text-white no-underline bg-blue-600 rounded-md cursor-pointer hover:text-white hover:bg-opacity-80 hover:transition-colors">
